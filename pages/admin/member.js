...
export default function MembersList() {
    ...
    const byTab = byStatus.filter((m) => (m.form_type || 'aadhaar_update') === tab);
    ...
    const aadhaarCount = byStatus.filter((m) => (m.form_type || 'aadhaar_update') === 'aadhaar_update').length;
    const detailsCount = byStatus.filter((m) => m.form_type === 'details_update').length;
            ...
            {selected && (
                <div className="table-card detail-view" style={{ marginBottom: 24 }}>
                    ...
                    <div className="detail-grid">
                        {selected.form_type !== 'aadhaar_update' && (
                            <>
            ...
            <div className="table-card">
                ...
                <div className="table-wrap">
                    {tab === 'aadhaar_update' ? (
                        ...
                        <table>
                            <thead>
                                <tr><th>Name</th><th>WhatsApp number</th><th>Email</th><th>Birth date</th><th>Area</th><th>Submitted date</th><th>Status</th><th>Actions</th></tr>
                            </thead>
                            <tbody>
                                {loading ? (
